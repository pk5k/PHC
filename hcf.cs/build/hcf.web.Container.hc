<?php #HYPERCELL hcf.web.Container - BUILD 22.02.27#22
namespace hcf\web;
class Container {
...
let dyn_cc='dyncc-'+register_to_fqn.replace('.','-').toLowerCase();let ecc=document.getElementById(dyn_cc);if(ecc!=null){return ecc;}
