	...
	public static function exStr($e, $with_markup = false)
	{
        ...
        foreach ($trace as $key => $stack_point) 
        {
            $result[] = sprintf(
                $traceline,
                $i,
                ((isset($stack_point['file'])) ? $stack_point['file'] : 'INTERNAL'),
                ((isset($stack_point['line'])) ? $stack_point['line'] : '-'),
                $stack_point['function'],
                implode(', ', $stack_point['args']),
                (isset($stack_point['suffix']) ? $stack_point['suffix'] : '')
            );
