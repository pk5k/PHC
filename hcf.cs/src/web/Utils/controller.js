class 
{
	static extendHTMLElements()
	{
		// Extend all HTMLElements by following shortcut functions to make navigating inside shadow DOMs easier (expecially inside hcf.web.Page views).
	...
	static recursiveOffset(aobj)
	{
		let me = hcf.web.Utils;
		...
		if(aobj !== null)
		{
			...
			{
			  	newOffset = me.recursiveOffset(aobj.parentNode);
			}
	...
	static cursor()
	{
		return hcf.web.Utils._cursor;
	}

	static registerCursorMoved()
	{
		document.onmousemove = hcf.web.Utils.cursorMoved;
	}

	//provide X/Y coordinates of the cursor over me.cursor(.x/.y)
	static cursorMoved(e)
	{
		let me = hcf.web.Utils;
		...
		if (me.cursor_timeout == null || me.cursor_timeout == undefined)
		{
			var doc = document.documentElement || document.body;
			var target = e.srcElement || e.target;
			var offsetpos = me.recursiveOffset(doc);

			let pos_x = e.clientX+offsetpos.x;
			let pos_y = e.clientY+offsetpos.y;
			...
			me.cursor_timeout = setTimeout(function() 
			{
